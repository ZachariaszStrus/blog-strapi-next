    ...
    return (
        <div className={`relative z-50 ${!showModal && 'hidden' }`}>
            ...
            <div className="fixed inset-0 z-10 overflow-y-auto" >
                <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-start sm:p-0 sm:mt-20"
                     onClick={(e) => {
                         e.stopPropagation()
                         e.preventDefault()
                         setShowModal(false)
                ...
                >
                    <div
                        ...
                        <Transition
                            ...
                            enterTo="opacity-100"
                        >
                        <div className="bg-background-dark px-4 pt-5 pb-4 sm:p-6 sm:pb-4" onClick={(e) => {
                            e.stopPropagation()
                            e.preventDefault()
                        }}>
                            {children}
